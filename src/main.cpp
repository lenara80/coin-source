...
unsigned int nStakeMinAge = 8 * nOneHour; // 0.33 day as zero time weight
...
unsigned int nModifierInterval = 0.4 * nOneHour; // time to elapse before new modifier is computed
...
const string strMessageMagic = "MalCoin Signed Message:\n";
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in MalCoin
...
bool CBlock::CheckBlock(bool fCheckPOW, bool fCheckMerkleRoot, bool fCheckSig) const
{
    ...
    if (fProofOfStake)
    {
        ...
        // MalCoin: check proof-of-stake block signature
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "MalCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "MALCOIN Genesis";
        CTransaction txNew;
        txNew.nTime = 1491242020;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1491242020;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 2795679; // !fTestNet ? 1575379 : 46534;

        block.print();

        //// debug print
        assert(block.hashMerkleRoot == uint256("0x6bccf9bf83d4c2781ccf97b90de28ca7e2feec5353e21e9ad8305fa193e3ff9c"));
...
unsigned char pchMessageStart[4] = { 0xb4, 0xfb, 0xec, 0xc5 };
