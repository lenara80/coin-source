...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("MALC");
    case mBTC: return QString("mMALC");
    case uBTC: return QString::fromUtf8("μMALC");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString(QObject::tr("MalCoins"));
    case mBTC: return QString(QObject::tr("Milli-MalCoins (1 / 1,000)"));
    case uBTC: return QString(QObject::tr("Micro-MalCoins (1 / 1,000,000)"));
    default: return QString("???");
    }
}
